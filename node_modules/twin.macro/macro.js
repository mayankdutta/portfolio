...
var renameJsxTags = function (ref) {
...
var makeStyledComponent = function (ref) {
  ...
  var elementName = get(jsxPath, 'node.name.name');
  var firstArg = isComponent(elementName) ? t.identifier(elementName) : t.stringLiteral(elementName);
...
}; // TODO: Let autoCssProp control this option if using stitches
...
var globalPreflightStyles = function (ref) {
  ...
  '*, ::before, ::after': {
    ...
    borderWidth: '0',
    borderStyle: 'solid',
    borderColor: theme(templateObject$1) || 'currentColor'
  },
  hr: {
    borderTopWidth: '1px'
  },
...
var globalStyles = [modernNormalizeStyles, globalPreflightStyles, globalKeyframeStyles, globalRingStyles, globalBoxShadowStyles];
...
var twinMacro = function (ref) {
  ...
  program.scope.crawl(); // Fixes: Cannot read property 'referencePaths' of undefined
};
